...
const BANKS: Record<TrackId, QuestionSeed[]> = {
  ...
  math: [
    { label: "Number sense", topic: "Number and operations", question: "Which calculation equals 3,600 ÷ 9?", hint: "Work out the division or use multiplication to check.", options: ["40", "400", "4,000", "32,400"], correct: 1 },
    { label: "Fractions", topic: "Number and operations", question: "3/4 − 1/8 = ?", hint: "Use a common denominator.", options: ["1/8", "3/8", "5/8", "7/8"], correct: 2 },
    { label: "Ratio", topic: "Ratio and percentage", question: "A recipe uses flour and sugar in the ratio 5:2. If 10 cups of flour are used, how many cups of sugar are needed?", hint: "Scale both parts by the same number.", options: ["2", "4", "5", "8"], correct: 1 },
    { label: "Percentage", topic: "Ratio and percentage", question: "A $240 item is reduced by 25%. What is the sale price?", hint: "Find one quarter of the original price first.", options: ["$60", "$180", "$200", "$300"], correct: 1 },
    { label: "Geometry", topic: "Geometry and measure", question: "A rectangle is 9 cm long and 5 cm wide. What is its area?", hint: "Area = length × width.", options: ["14 cm²", "28 cm²", "45 cm²", "90 cm²"], correct: 2 },
    { label: "Measure", topic: "Geometry and measure", question: "A journey starts at 14:35 and lasts 1 hour 45 minutes. When does it end?", hint: "Add the hours and minutes carefully.", options: ["15:20", "16:10", "16:20", "17:10"], correct: 2 },
    { label: "Data", topic: "Data and statistics", question: "The numbers 6, 8, 8, 10 and 13 have which median?", hint: "Put the data in order and find the middle number.", options: ["6", "8", "9", "13"], correct: 1 },
    { label: "Graphs", topic: "Data and statistics", question: "A bar chart shows 12 students chose art and 18 chose music. How many more chose music?", hint: "Find the difference.", options: ["4", "6", "12", "30"], correct: 1 },
    { label: "Algebra", topic: "Multi-step problem solving", question: "Solve 4x + 7 = 31.", hint: "Move the constant first, then divide.", options: ["4", "5", "6", "8"], correct: 2 },
    { label: "Multi-step", topic: "Multi-step problem solving", question: "A class buys 6 packs of pencils. Each pack has 8 pencils. After giving away 11 pencils, how many remain?", hint: "Multiply first, then subtract.", options: ["26", "37", "48", "59"], correct: 1 },
  ],
  science: [
...
export function buildQuestionPool(track: TrackId, grade: GradeId): AssessmentQuestion[] {
  return BANKS[track].flatMap((seed, seedIndex) => CONTEXTS.map((context, variant) => ({
    ...seed,
