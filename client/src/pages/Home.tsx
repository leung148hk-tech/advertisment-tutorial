...
export default function Home() {
  ...
  const unlockReport = (event: FormEvent<HTMLFormElement>) => { event.preventDefault(); if (!form.parentName.trim() || !form.whatsapp.trim() || !form.district) { setFormError("請完成家長稱呼、WhatsApp 號碼和所在區域，才可查看報告。"); return; } setFormError(""); setStage("report"); };
